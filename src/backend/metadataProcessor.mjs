...
function processDocument(doc) {
  ...
  const actualSubfolder = doc.type || "default"; //default path will be /media
  return {
    id: doc._id.toString(),
    ...
    thumbnailUrl: `/media/thumbnails/${filename}.webp`, // Construct thumbnail URL
    actualUrl: `/media/${actualSubfolder}/${filename}.webp`, // Construct actual URL
  };
}
